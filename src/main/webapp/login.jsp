		...
		<div class="card card-container">
			...
			<form action="<s:url action="login"/>" method="POST" class="form-signin">
				<span id="reauth-email" class="reauth-email"></span>
				 <input type="text" id="inputusr" name="login.usr" class="form-control" placeholder="Usuario" required autofocus> 
				 <input type="password" id="inputPassword" name="login.pwd" class="form-control" placeholder="Contraseña" required>
